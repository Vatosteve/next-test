    ...
    <nav className="flex items-center justify-between px-6 py-3 bg-neutral-950 border-b border-neutral-800/60">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 bg-neutral-800 hover:bg-neutral-700 rounded-full pl-1 pr-3 py-1 cursor-pointer transition-colors">
          ...
          <span className="text-sm text-neutral-200 font-medium">Kate Schowalter</span>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
