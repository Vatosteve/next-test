      ...
      <main className="max-w-7xl mx-auto px-6 py-7 space-y-5">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-neutral-400 text-xs mb-1 tracking-wide">Your daily plan</p>
            <h1 className="text-3xl font-semibold text-white leading-tight">Stay on Track Today</h1>
          </div>
          ...
          <div className="flex items-center gap-3 bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-3 shrink-0">
            ...
            <div className="w-10 h-10 rounded-xl bg-neutral-800 flex items-center justify-center shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-neutral-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <div>
              <p className="text-white text-sm font-medium">Keep it going!</p>
              <p className="text-neutral-400 text-xs">You've done all previous tasks!</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between bg-neutral-900 border border-neutral-800/60 rounded-2xl px-5 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="bg-neutral-800 rounded-xl px-3 py-2 text-center min-w-[3.5rem]">
              ...
              <p className="text-xs text-neutral-400 uppercase tracking-widest mt-0.5">Oct</p>
            </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800/60 rounded-2xl p-5">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <h2 className="text-white font-semibold text-sm">Daily Timeline</h2>
          ...
          <div className="flex mb-2">
            {timeLabels.map((t) => (
              <div key={t} className="flex-1 text-xs text-neutral-500 text-left">
                {t}
              </div>
            ))}
          </div>
          ...
          <div className="relative h-28 rounded-xl bg-neutral-800/40 overflow-hidden">
            ...
            >
              ...
              <span className="text-white text-xs font-medium whitespace-nowrap">Plan Weekly Routine</span>
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-400 shrink-0" />
                <span className="text-neutral-400 text-xs whitespace-nowrap">Low Priority</span>
              </div>
            </div>
            ...
            >
              ...
              <span className="text-white text-xs font-medium whitespace-nowrap">Review Project Materials</span>
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 rounded-full bg-teal-400 shrink-0" />
                <span className="text-neutral-400 text-xs whitespace-nowrap">Important</span>
              </div>
            </div>
            ...
            >
              ...
              <span className="text-white text-xs font-medium whitespace-nowrap">Call With Client</span>
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 rounded-full bg-red-400 shrink-0" />
                <span className="text-neutral-400 text-xs whitespace-nowrap">High priority</span>
              </div>
            </div>
          </div>
        </div>
